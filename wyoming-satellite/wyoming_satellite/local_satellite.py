...
class LocalWakeStreamingSatellite(SatelliteBase):
    ...
    def __init__(self, settings: SatelliteSettings) -> None:
        ...
        # Initialize Vosk STT
        self.model = Model("/home/pi/vosk-model/vosk-model-small-en-us-0.15")
    ...
    def save_transcript(self, transcript: str) -> None:
        ...
        transcript_file = "/home/pi/transcripts.txt"
